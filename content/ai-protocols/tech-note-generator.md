...
{{% notice info %}}
**Nota de Versión:** Este es el protocolo original. Se recomienda utilizar la **[Versión II (Optimización UI)]({{% relref "tech-note-generator-ii.md" %}})** para obtener mejores resultados en el menú lateral.
{{% /notice %}}
...
1. **Captura:** Copia el texto raw de la fuente.
2. **Ejecución:** Pega el prompt maestro seguido de la captura en la IA.
3. **Refinado:** Guarda el resultado como `.md` en `/notes`.
