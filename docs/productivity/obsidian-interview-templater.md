...
date: 2026-01-10
description: "Sistema de automatización para el seguimiento de entrevistas técnicas utilizando Obsidian y el plugin Templater."
tags:
  - Obsidian
  - Templater
  - Workflow
...
# Seguimiento de Entrevistas con Obsidian {: #obsidian-templater }

!!! note "Propósito"
    Este artículo documenta la lógica técnica detrás de mi sistema de seguimiento de entrevistas. El objetivo es estandarizar la captura de datos críticos durante procesos de selección, permitiendo una preparación técnica basada en datos.
...
!!! tip "Consejo"
    Registrar 'Pain Points' mencionados por el entrevistador.
